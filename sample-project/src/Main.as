...
public class Main extends Sprite {
    ...
    private static const PURCHASE_PRODUCT_ID:String = "purchase_item";
    ...
    public static function trackInAppPurchase(product:String, revenue:Number, currency:String, virify:Boolean = true):void {
        if (virify) {
